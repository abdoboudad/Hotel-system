    ...
    <div class="card-body">
        <form action="{{ route('room.store') }}" method="post">
            ...
            <div class="mb-3">
                ...
                <select class="form-select" name="client_id" aria-label="{{ __('custom.client_select') }}">
                    <option selected>{{ __('custom.client_select') }}</option>
            ...
            <div class="mb-3">
                ...
                <select class="form-select" name="room_type" aria-label="{{ __('custom.Select the room please') }}">
                    <option selected>{{ __('custom.room_select') }}</option>
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" value="{{ old('room_num') }}"  aria-describedby="emailHelp" name="room_num" placeholder="{{ __('custom.Room number') }}">
            </div>
            <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">{{ __('custom.Room price') }}</label>
                <input type="number" class="form-control"  id="room_price"  aria-describedby="emailHelp" placeholder="{{ __('custom.Room price') }}" required>
            </div>

            <!-- Rest of the HTML code using __('custom.key') for translation -->
            <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">{{ __('custom.Room reservation') }}</label>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="reserved" value="true" id="ontrue">
                    <label class="form-check-label" for="ontrue">
                        {{ __('custom.Reserved') }}
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="reserved" value="false" id="onfalse" checked>
            ...
            <div class="mb-3" id="payment" style="display: none;">
                ...
                <select class="form-select" id="choose_pay" aria-label="{{ __('custom.Payment status') }}">
                ...
                <div class="px-4 py-2" id="prices" style="display: none;">
                    ...
                    <input type="number" class="form-control" value="{{ old('first_price') }}" id="first_price" aria-describedby="emailHelp" name="first_price" placeholder="{{ __('custom.first_price_label') }}">
                    <label for="exampleInputEmail1" class="form-label">{{ __('custom.final_price_label') }}</label>
                    <input type="number" class="form-control" value="{{ old('final_price') }}" id="final_price" aria-describedby="emailHelp" name="final_price" placeholder="{{ __('custom.final_price_label') }}">
                </div>
            </div>
            <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">{{ __('custom.Reservation date') }}</label>
                <input type="date" class="form-control" id="rev_date" value="{{ old('rev_date') }}" aria-describedby="emailHelp" name="rev_date">
            </div>
            <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">{{ __('custom.Reservation expiration date') }}</label>
                <input type="date" class="form-control" id="rev_ex_date" value="{{ old('rev_ex_date') }}" aria-describedby="emailHelp" name="rev_ex_date">
            </div>
            <div style="border-radius:5px" class="p-2 bg-dark bg-gradient text-light">
                <ul class="m-0">
                    ...
                    <li>
                        <span><strong>{{ __('custom.Price') }}:</strong><span id="price" class="mx-2"></span></span>
                    </li>
                    <li>
                        <span><strong>{{ __('custom.Total price') }}:</strong><input type="number" name="total_price" id="total_price" hidden><span class="mx-2" id="mytotal"></span><span>$</span></span>
                    </li>
                </ul>
            </div>
